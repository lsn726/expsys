...
public class Main {
	...
	public static void main(String[] args) {
		//DemandProcess.importDemandFromExcel("e:\\NewDemand.xlsx");					//从Excel文件导入新需求
		...
		ProductionProcess.extractOutputDataFromPdExcelFileToDB("E:\\RS23.xls", -1);		//将生产日报导入数据库。《《将导入所有数据》》
