...
public class BWIPdExcelInfoFA_Module extends BWIPdExcelInfoFA {
	...
	protected void initLocVerifyStrMap() {
		...
		VERIFYMAP_LOC_STR.put(new Location(19,13), "F T Q");
		VERIFYMAP_LOC_STR.put(new Location(19,40), "F T Q");
		VERIFYMAP_LOC_STR.put(new Location(19,67), "F T Q");
		VERIFYMAP_LOC_STR.put(new Location(19,18), "Lost time");
		VERIFYMAP_LOC_STR.put(new Location(19,45), "Lost time");
		VERIFYMAP_LOC_STR.put(new Location(19,72), "Lost time");
		VERIFYMAP_LOC_STR.put(new Location(21,13), "Part No\n零件号");
		VERIFYMAP_LOC_STR.put(new Location(21,40), "Part No\n零件号");
		VERIFYMAP_LOC_STR.put(new Location(21,67), "Part No\n零件号");
		VERIFYMAP_LOC_STR.put(new Location(21,14), "Failure Mode\n失效模式");
		VERIFYMAP_LOC_STR.put(new Location(21,41), "Failure Mode\n失效模式");
		VERIFYMAP_LOC_STR.put(new Location(21,68), "Failure Mode\n失效模式");
		VERIFYMAP_LOC_STR.put(new Location(21,15), "Rework\n返工");
		VERIFYMAP_LOC_STR.put(new Location(21,42), "Rework\n返工");
		VERIFYMAP_LOC_STR.put(new Location(21,69), "Rework\n返工");
		VERIFYMAP_LOC_STR.put(new Location(21,16), "Scrap\n报废");
		VERIFYMAP_LOC_STR.put(new Location(21,43), "Scrap\n报废");
		VERIFYMAP_LOC_STR.put(new Location(21,70), "Scrap\n报废");
		VERIFYMAP_LOC_STR.put(new Location(21,17), "Remarks\n备注");
		VERIFYMAP_LOC_STR.put(new Location(21,44), "Remarks\n备注");
		VERIFYMAP_LOC_STR.put(new Location(21,71), "Remarks\n备注");
		VERIFYMAP_LOC_STR.put(new Location(21,18), "Time\n时段");
		VERIFYMAP_LOC_STR.put(new Location(21,45), "Time\n时段");
		VERIFYMAP_LOC_STR.put(new Location(21,72), "Time\n时段");
		VERIFYMAP_LOC_STR.put(new Location(21,19), "Lost time\n损失时间");
		VERIFYMAP_LOC_STR.put(new Location(21,46), "Lost time\n损失时间");
		VERIFYMAP_LOC_STR.put(new Location(21,73), "Lost time\n损失时间");
		VERIFYMAP_LOC_STR.put(new Location(21,20), "LT mode\n损失类型");
		VERIFYMAP_LOC_STR.put(new Location(21,47), "LT mode\n损失类型");
		VERIFYMAP_LOC_STR.put(new Location(21,74), "LT mode\n损失类型");
		VERIFYMAP_LOC_STR.put(new Location(21,21), "Cause\n原因");
		VERIFYMAP_LOC_STR.put(new Location(21,48), "Cause\n原因");
		VERIFYMAP_LOC_STR.put(new Location(21,75), "Cause\n原因");
		VERIFYMAP_LOC_STR.put(new Location(21,22), "Remarks\n备注");
		VERIFYMAP_LOC_STR.put(new Location(21,49), "Remarks\n备注");
		VERIFYMAP_LOC_STR.put(new Location(21,76), "Remarks\n备注");
