...
public abstract class BWIPdExcelDataExtractor_DamperFA extends BWIPdExcelDataExtractor {
	...
	/**FTQ and Lost Time起始行,勿修改*/
	protected static final int FTQ_LT_STARTROW=25;
	
	/**FTQ and Lost Time表头起始行,勿修改*/
	protected static final int FTQ_LT_HEADER_STARTROW=27;
	...
	protected void initIntervalValidator() {
		int rowindex=OUTPUTDATA_STARTROW;
		Calendar cal=Calendar.getInstance();
		cal.clear();
		cal.set(1900, 1, 0);
		cal.set(Calendar.HOUR, 8);
		cal.set(Calendar.MINUTE, 15);
		FALocDateValidator.put(new Location(rowindex,SHIFTEARLY_OUTPUTQTYCOL+RELATIVECAL_INTERVAL_BEGIN), cal.getTime());
		cal.clear();
		cal.set(1900, 1, 0);
		cal.set(Calendar.HOUR, 9);
		cal.set(Calendar.MINUTE, 0);
		FALocDateValidator.put(new Location(rowindex++,SHIFTEARLY_OUTPUTQTYCOL+RELATIVECAL_INTERVAL_END), cal.getTime());
		cal.clear();
		cal.set(1900, 1, 0);
		cal.set(Calendar.HOUR, 9);
		cal.set(Calendar.MINUTE, 0);
		...
		cal.set(Calendar.MINUTE, 0);
		FALocDateValidator.put(new Location(rowindex++,SHIFTEARLY_OUTPUTQTYCOL+RELATIVECAL_INTERVAL_END), cal.getTime());
		rowindex=OUTPUTDATA_STARTROW;
		cal.clear();
		cal.set(1900, 1, 0);
		cal.set(Calendar.HOUR, 17);
		cal.set(Calendar.MINUTE, 0);
		FALocDateValidator.put(new Location(rowindex,SHIFTMIDDLE_OUTPUTQTYCOL+RELATIVECAL_INTERVAL_BEGIN), cal.getTime());
		cal.clear();
		cal.set(1900, 1, 0);
		cal.set(Calendar.HOUR, 18);
		cal.set(Calendar.MINUTE, 0);
		FALocDateValidator.put(new Location(rowindex++,SHIFTMIDDLE_OUTPUTQTYCOL+RELATIVECAL_INTERVAL_END), cal.getTime());
		cal.clear();
		cal.set(1900, 1, 0);
		cal.set(Calendar.HOUR, 18);
		cal.set(Calendar.MINUTE, 30);
		...
		cal.set(Calendar.HOUR, 2);
		cal.set(Calendar.MINUTE, 0);
		FALocDateValidator.put(new Location(rowindex,SHIFTNIGHT_OUTPUTQTYCOL+RELATIVECAL_INTERVAL_BEGIN), cal.getTime());
		cal.clear();
		cal.set(1900, 1, 0);
		cal.set(Calendar.HOUR, 3);
		cal.set(Calendar.MINUTE, 0);
		FALocDateValidator.put(new Location(rowindex++,SHIFTNIGHT_OUTPUTQTYCOL+RELATIVECAL_INTERVAL_END), cal.getTime());
		cal.clear();
		cal.set(1900, 1, 0);
		cal.set(Calendar.HOUR, 3);
		cal.set(Calendar.MINUTE, 10);
	...
	protected void initOutputLocIntervalMap() {
		...
		//早班区间初始化
		int rowindex=OUTPUTDATA_STARTROW;		//行索引初始化
		...
		cal.set(Calendar.HOUR_OF_DAY, 17);		//设置区间开始时间
		cal.set(Calendar.MINUTE, 0);
		begin=cal.getTime();
		cal=(Calendar)INIT_CALENDAR.clone();
		...
		dinterval=new DateInterval(begin,end);
		outputlocdatemap.put(new Location(rowindex++,SHIFTNIGHT_OUTPUTQTYCOL), dinterval);
		outputlocdatemap.put(new Location(rowindex++,SHIFTNIGHT_OUTPUTQTYCOL), dinterval);
		outputlocdatemap.put(new Location(rowindex++,SHIFTNIGHT_OUTPUTQTYCOL), dinterval);
		outputlocdatemap.put(new Location(rowindex++,SHIFTNIGHT_OUTPUTQTYCOL), dinterval);
		cal=(Calendar)INIT_CALENDAR.clone();
		...
		begin=cal.getTime();
		cal=(Calendar)INIT_CALENDAR.clone();
		cal.set(Calendar.HOUR_OF_DAY,31);
		cal.set(Calendar.MINUTE, 0);
		end=cal.getTime();
		dinterval=new DateInterval(begin,end);
		outputlocdatemap.put(new Location(rowindex++,SHIFTNIGHT_OUTPUTQTYCOL), dinterval);
		...
		begin=cal.getTime();
		cal=(Calendar)INIT_CALENDAR.clone();
		cal.set(Calendar.HOUR_OF_DAY,32);
		cal.set(Calendar.MINUTE, 15);
		end=cal.getTime();
		dinterval=new DateInterval(begin,end);
		outputlocdatemap.put(new Location(rowindex++,SHIFTNIGHT_OUTPUTQTYCOL), dinterval);
